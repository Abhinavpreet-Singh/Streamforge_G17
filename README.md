...
| Noore Simin | nooresimin2005 | Dashboard · validator · throughput chart |
| Shifana | Shifana14-d | `/topology` · `/metrics` |
| Raghavendra | kraghavendra2500-code | 50k dataset · validation script |
...
copy .env.example .env          # optional — demo defaults
docker compose up -d
...
Or run `.\scripts\run_demo.ps1` for stack setup + instructions.
